...
export class MemberApi{
    ...
    city(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/city',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    shuxin(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/shuxin',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    video(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/video',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    xiangqin(json, callback, showLoading = true) {
